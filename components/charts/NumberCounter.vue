...
const props = withDefaults(defineProps<Props>(), {
  formatter: (value: number) => new Intl.NumberFormat("de-DE").format(Math.round(value)),
...
<template>
  <div>
    <div class="border-t border-black">
      ...
      <div class="number-counter border-l border-r border-black/30 text-right px-1 pb-2">
